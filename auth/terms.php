...
<section class="py-5 bg-primary text-white text-center">
    <div class="container">
        ...
        <p class="mb-0">Ketentuan Penggunaan Layanan Vibes Kost</p>
    </div>
</section>
            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-body p-4">
                    ...
                    <div class="small text-muted mb-3">
                        <i class="fas fa-clock"></i> Terakhir diperbarui: 1 Januari 2025
                    </div>

                    <!-- Item template -->
                    <div class="mb-4">
                        <h5 class="fw-bold text-primary"><i class="fas fa-check-circle me-2"></i>1. Penerimaan</h5>
                        <p class="mb-0">
                            Dengan menggunakan layanan Vibes Kost, Anda menyetujui seluruh syarat & ketentuan yang berlaku.
                        </p>
                    </div>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold text-primary"><i class="fas fa-book me-2"></i>2. Definisi</h5>
                        <ul class="mb-0">
                            <li>Platform: Website & aplikasi Vibes Kost</li>
                            <li>Pengguna: Individu yang mengakses Platform</li>
                            <li>Penyewa & Pemilik Kost</li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold text-primary"><i class="fas fa-user-plus me-2"></i>3. Pendaftaran</h5>
                        <p class="mb-1 fw-semibold">Persyaratan:</p>
                        <ul>
                            <li>Minimal 17 tahun</li>
                            <li>Informasi akurat & valid</li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold text-primary"><i class="fas fa-wallet me-2"></i>4. Pembayaran</h5>
                        <p class="mb-0">Pembayaran dilakukan melalui transfer bank / QRIS resmi.</p>
                    </div>

                    <hr>

                    <div class="alert alert-warning text-center">
                        <i class="fas fa-exclamation-triangle"></i> Dengan menggunakan layanan kami, Anda dianggap menyetujui seluruh ketentuan.
                    </div>
